...
# [Ozon и Wildberies – экспорт карточки товара в txt](https://github.com/nikmedoed/myTampermonkeyScripts/raw/main/OZON-WB-tools/Product-card-extract-OZON-WB.user.js)
...
Дополнительно скрипт показывает график истории цены рядом с блоком цены на странице товара (если история доступна).
...
Подробная инструкция по серверу и синхронизации: [OZON-WB-tools/README.md](OZON-WB-tools/README.md)
